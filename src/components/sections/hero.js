...
export default function Hero() {
    ...
    return (
        <div class="min-h-screen " >
            ...
            <p class="text-xl text-slate-400 max-w-md opacity-0" id="three">I'm a Computer Science major at the <a className="text-purple-500" href="https://umich.edu/" target="_blank">University of Michigan</a> with a passion for software development and engineering.</p>
            <br/>
